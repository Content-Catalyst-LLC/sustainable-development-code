...
region_output_file <- "articles/land-system-change-and-development-pathways/data/cross_region_land_system_summary.csv"
territory_output_file <- "articles/land-system-change-and-development-pathways/data/cross_territory_land_system_summary.csv"
